            ...
            <div className="container mx-auto px-4 py-12">
               ...
               viewport={{ once: true, amount: 0.3 }}
                className="text-center mb-0">
                    <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-green-600  dark:from-white dark:to-gray-300 mb-4">
